...
public class subtraction {
	ChromeDriver driver;
	  ...
	  public void f() {
		  ...
		  driver.findElementByCssSelector("tr:nth-child(2) td:nth-child(2) div:nth-child(1) div:nth-child(1) > span.scinm:nth-child(2)").click();
		  driver.findElementByCssSelector("tr:nth-child(2) td:nth-child(2) div:nth-child(1) div:nth-child(3) > span.scinm:nth-child(2)").click();
		  driver.findElementByCssSelector("tr:nth-child(2) td:nth-child(2) div:nth-child(1) div:nth-child(3) > span.scinm:nth-child(3)").click();
		  driver.findElementByCssSelector("tr:nth-child(2) td:nth-child(2) div:nth-child(1) div:nth-child(2) > span.sciop:nth-child(4)").click();
		  driver.findElementByCssSelector("tr:nth-child(2) td:nth-child(2) div:nth-child(1) div:nth-child(2) > span.sciop:nth-child(4)").click();
		  driver.findElementByCssSelector("tr:nth-child(2) td:nth-child(2) div:nth-child(1) div:nth-child(3) > span.scinm:nth-child(2)").click();
		  driver.findElementByCssSelector("tr:nth-child(2) td:nth-child(2) div:nth-child(1) div:nth-child(3) > span.scinm:nth-child(3)").click();
		  ...
		  driver.findElementByCssSelector("tr:nth-child(2) td:nth-child(2) div:nth-child(1) div:nth-child(1) > span.scinm:nth-child(3)").click();
		  driver.findElementByCssSelector("tr:nth-child(2) td:nth-child(2) div:nth-child(1) div:nth-child(2) > span.scinm:nth-child(1)").click();
		  driver.findElementByCssSelector("tr:nth-child(2) td:nth-child(2) div:nth-child(1) div:nth-child(1) > span.scinm:nth-child(2)").click();
		  driver.findElementByCssSelector("tr:nth-child(2) td:nth-child(2) div:nth-child(1) div:nth-child(3) > span.scinm:nth-child(2)").click();
		  driver.findElementByCssSelector("tr:nth-child(2) td:nth-child(2) div:nth-child(1) div:nth-child(3) > span.scinm:nth-child(3)").click();
